            ...
            <div className='bg-white p-6 rounded-lg shadow'>
                ...
                <form onSubmit={handleChange} className='space-y-4'>
                    ...
                    <div>
                        ...
                        <input type="text" className='w-full p-3 border-gray-200 rounded-lg' placeholder='Please enter your username' onChange={(e)=>setEditForm({...editForm,username:e.target.value})} value={editForm.username}/>
                    </div>
                    ...
                    <div className='flex justify-end space-x-3 pt-3'>
                        <button type='button' onClick={()=>setShowEdit(false)} className='px-4 py-2 border-gray-300 rounded-lg
